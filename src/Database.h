...
#ifndef _FBOW_DATABASE_H
#define _FBOW_DATABASE_H
...
public:
   ...
   * @return vocabulary
   */
  inline const std::shared_ptr<Vocabulary> getVocabulary() const;
   ...
   * @param db
   */
 FBOW_API friend   std::ostream& operator<<(std::ostream &os,
                                    const Database &db);
...
protected:
  ...
  std::shared_ptr<Vocabulary> m_voc = nullptr;
